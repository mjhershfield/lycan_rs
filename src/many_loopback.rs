...
fn main() {
    ...
    // Print d3xx version
    println!("D3XX version is {:?}", ft60x_rs::d3xx_version());
    ...
    for _ in 0..num_loopbacks {
        ...
        current_address = ((current_address + 1) % 7) + 1;
    }

    println!(
        "Successful Loopbacks: {}/{} ({}%)",
        successes,
        num_loopbacks,
        successes * 100 / num_loopbacks
    );
}
